...
namespace Kvant
{
    ...
    public class Stream : MonoBehaviour
    {
        ...
        Mesh CreateMesh()
        {
            ...
            var vertices = new Vector3[Nx * Ny * 2];
            ...
            for (var x = 0; x < Nx; x++)
            {
                for (var y = 0; y < Ny; y++)
                {
                    vertices[i + 0] = new Vector3(1, 0, 0);
                    vertices[i + 1] = new Vector3(0, 0, 0);

                    var u = (float)x / Nx;
                    var v = (float)y / Ny;
                    TA[i] = TA[i + 1] = new Vector2(u, v);
            ...
            for (i = 0; i < vertices.Length; i++) indices[i] = i;
